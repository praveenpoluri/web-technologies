...
var url='mongodb://imprudhvi:Prudhvi123@ds119273.mlab.com:19273/wmcdemo';//1.Modify this url with the credentials of your db name and password.
...
app.get('/delete/:toBeDeleted_id', function (req, res) {
    ...
    MongoClient.connect(url, function(err, db) {
        ...
        db.collection("books").deleteOne(myquery,function(err, res) {
            if (err) throw err;

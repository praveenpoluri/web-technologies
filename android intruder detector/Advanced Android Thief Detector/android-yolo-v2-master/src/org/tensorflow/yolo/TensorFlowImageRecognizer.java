...
public class TensorFlowImageRecognizer {
     ...
     *Asset manager is to get classifier with all the instances from input
    ...
    public static TensorFlowImageRecognizer create(AssetManager assetManager) {
        ...
        return recognizer;//classifies based on size,shape number of pixels along length and width
    }
